...
import type { ApplicantResponse, RecruiterResponse, UserResponse } from "@/types/dto";
...
export type FetchUserResponse = IBackendRes<
  UserResponse | RecruiterResponse | ApplicantResponse
>;
